...
import { logout } from "../src/redux/slices/authSlice"; // adjust path as needed
...
export function Header() {
  ...
  // This function calls your logout endpoint (if you have one)
  // and then dispatches the Redux logout action.
  const handleLogout = async () => {
    try {
      // If using an API to clear cookies or server sessions:
      ...
      // Navigate the user to login or home
      navigate("/login");
    } catch (error) {
      console.error("Logout error:", error);
      // Possibly show a toast or error message
    }
  };
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="relative flex h-full w-3/4 max-w-sm flex-col border-r border-gray-200 bg-white p-6 shadow-xl">
            ...
            <nav className="flex flex-col gap-1.5">
              ...
              {/* Logout in mobile drawer as well */}
              <button
                onClick={() => {
