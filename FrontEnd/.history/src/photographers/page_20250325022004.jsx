...
export default function PhotographerPage() {
  ...
  const { data, isLoading, isError, error } = useGetPhotographersQuery();
  const photographerList = data?.photographers || [];

  // Filter photographers using default empty string if a property is undefined
        ...
        <div className="container py-8">
          ...
          <div className="grid gap-6 md:grid-cols-[300px_1fr]">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-lg border bg-white shadow-sm">
                <div className="p-4 space-y-4">
                  <h3 className="text-lg font-medium">Price Range (per hour)</h3>
                  <input
                    type="range"
                    min="0"
                    max="300"
