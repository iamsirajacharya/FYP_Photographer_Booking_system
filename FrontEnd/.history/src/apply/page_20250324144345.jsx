...
export default function ApplyPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    experience: "",
    equipment: "",
    specialty: [], // array of selected specialties
  ...
  const handleSubmit = async (e) => {
    ...
    // ✅ FIXED: Send the first specialty or "General" as a single string
    applicationData.append("specialty", formData.specialty[0] || "General");

    // ✅ Send all specialties (array) for the association table
          ...
          {formSubmitted ? (
            ...
            <div className="rounded-lg bg-white p-6 shadow-sm">
              ...
              <form onSubmit={handleSubmit}>
                ...
                {currentStep === 3 && (
                  <div className="space-y-4">
                    {/* Portfolio images, Website, Instagram, HourlyRate, MinHours, AdditionalInfo */}
                    {/* Keep as-is */}
                  </div>
                )}
              </form>
