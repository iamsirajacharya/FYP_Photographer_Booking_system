...
const ProfilePage = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    bio:
      user?.bio ||
      "Photography enthusiast with a passion for capturing special moments.",
                ...
                {activeTab === "bookings" && (
                  <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    <div className="flex border-b border-gray-200 mb-6 overflow-x-auto">
                      <button className="px-4 py-2 text-purple-600 border-b-2 border-purple-600 font-medium whitespace-nowrap">
                        All Bookings
                      </button>
