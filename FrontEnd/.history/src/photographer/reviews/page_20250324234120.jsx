  ...
  return (
    <div className="container py-8">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="border rounded shadow p-4 md:col-span-1">
          <h2 className="text-lg font-bold">Review Summary</h2>
          <p className="text-gray-600">Your overall rating and statistics</p>
        ...
        {/* Reviews List */}
        <div className="border rounded shadow p-4 md:col-span-2">
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <div className="space-y-4">
              <div className="rounded-md bg-gray-50 p-3">
                <p className="text-sm text-gray-600">{reportReview?.comment}</p>
              </div>
