    ...
    <div className="container py-8">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-gray-600">Manage your photography sessions</p>
        </div>
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        {booking.status === "pending" && (
                          <>
                            <button className="bg-green-600 hover:bg-green-700 text-white px-2 py-1 rounded text-sm">
                              Accept
                            </button>
                            <button className="border border-red-600 text-red-600 hover:bg-red-50 px-2 py-1 rounded text-sm">
                              Decline
                            </button>
                          </>
                        )}
