  ...
  return (
    <div className="overflow-hidden rounded-lg border bg-white shadow-sm transition-all duration-200 hover:shadow-md">
      ...
      <div className="flex items-center justify-between bg-purple-50 p-4 border-t">
        ...
        <Link
          to={`/photographers/${id}`} // Use the passed 'id' prop
          className="inline-flex items-center justify-center rounded-md bg-purple-600 px-4 py-2 text-sm font-medium text-white shadow transition-colors hover:bg-purple-700 focus-visible:outline-none focus-visible:ring-1"
        >
          View Profile
        </Link>
      </div>
