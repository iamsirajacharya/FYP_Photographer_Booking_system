...
exports.getPendingApplications = catchAsync(async (req, res) => {
  ...
  const { count, rows } = await db.Photographer.findAndCountAll({
    ...
    attributes: [
      ...
      "specialty",
      "experience",
      "applicationDate", // Use the correct column name
      "location",
      "equipment",
      "hourlyRate",
      "portfolioImages",
    ...
    limit: Number.parseInt(limit),
    offset: Number.parseInt(offset),
    order: [["applicationDate", "DESC"]], // Sort by the correct column
  });
  ...
  const applications = rows.map((photographer) => ({
    ...
    applicationDate: photographer.applicationDate,
    location: photographer.location,
    equipment: photographer.equipment,
    hourlyRate: photographer.hourlyRate,
    portfolio: photographer.portfolioImages,
  }));
