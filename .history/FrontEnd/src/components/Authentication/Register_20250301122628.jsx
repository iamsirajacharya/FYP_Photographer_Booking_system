...
const Register = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    password: "",
    confirmPassword: "", // Added to include this field
    phone: "",
    role: "client", // Default role
    profile_image: null,
    agreesToTerms: false, // Added to include this field
  });

  // Loading and error state
  const [loading, setLoading] = useState(false);
  const [errors, setErrors] = useState({}); // Changed from null to empty object
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(ApiLink.register.url, submitData, {
        headers: {
